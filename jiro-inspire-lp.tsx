      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">人気の"二郎インスパイア"をご家庭で！</h1>
      ...
      <section className="bg-yellow-100 py-4">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <div className="bg-red-600 text-white px-3 py-1 rounded text-sm font-bold">ランキング1位</div>
            <div className="bg-red-600 text-white px-3 py-1 rounded text-sm font-bold">ランキング1位</div>
          </div>
        </div>
      </section>
